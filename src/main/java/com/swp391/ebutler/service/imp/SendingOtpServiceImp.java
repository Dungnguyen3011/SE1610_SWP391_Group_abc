...
@Service
@Transactional
public class SendingOtpServiceImp implements SendingOtpService {

	@Autowired
	EmailSenderService emailsv;
	...
	public Integer sendOtp(OtpSendingDTO otp) {
		Account acc = accsv.find(otp.getEmail());
		if(acc != null) {
			return -1;
		}else {
			String otpcode = new DecimalFormat("000000").format(new Random().nextInt(999999));
			emailsv.send(otp.getEmail(), buildEmail(otp.getName(), otpcode));
	...
	private String buildEmail(String name, String otp) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Complete your sign up process</span>\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "              </a>\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Here is the OTP code to complete signing up your account:</p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a>" + otp + "</a> </p></blockquote>\n <p>Thank you for join with us !</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
